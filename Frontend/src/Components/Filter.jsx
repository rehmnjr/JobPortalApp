  ...
  return (
    <div className='flex w-screen items-center justify-evenly shadow-md p-4'>
      ...
      <div className='flex items-center gap-3 max-w-fit'>
        <IoIosSearch size={22}/>
        <input type="text" name='jobTitle' onChange={handleChange} placeholder='Search By Job Title, Role' className='px-4 py-2 max-w-fit outline-none focus:outline-none focus:ring-0 focus:border-transparent' />
      </div>
      ...
      <div className='flex items-center gap-3 max-w-fit'>
        ...
        <div className="w-full max-w-md">
          <select onChange={getChangeVal} placeholder="Preferred location" name='location' className='outline-none focus:outline-none focus:ring-0 focus:border-transparent'>
      ...
      <div className='flex items-center gap-3 max-w-fit'>
        <GoPerson size={22} />
        <select onChange={getChangeVal} name="jobType" className="px-4 py-2 min-w-fit text-black w-[209px] outline-none focus:outline-none focus:ring-0 focus:border-transparent">
