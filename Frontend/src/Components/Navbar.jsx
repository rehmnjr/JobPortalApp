...
const handleCreate = ()=>{
  ...
  return (
    <div className='w-[890px] h-[80px] font-satoshi rounded-[100px] py-4' style={{boxShadow:`rgba(99, 99, 99, 0.2) 0px 2px 8px 0px`,}}>
     ...
     <li className='font-[600]'><img src={Logo} alt="" /></li>
     <li className='font-[600]'>Home</li>
     <li className='font-[600]'>Find Jobs</li>
     <li className='font-[600]'>Find Talents</li>
     <li className='font-[600]'>About Us</li>
     <li className='font-[600]'>Testimonials</li>
